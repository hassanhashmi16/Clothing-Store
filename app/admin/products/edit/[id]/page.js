...
export default function EditProductPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.patch('/api/admin/products', productData);
            ...
            <form onSubmit={handleSubmit} className="space-y-16">
                ...
                <section className="space-y-8">
                    <div className="border-l-2 border-stone-900 pl-6">
                        ...
                        <p className="text-[10px] text-stone-400 uppercase tracking-widest">Modified identification and pricing</p>
                    </div>
                ...
                <section className="space-y-8">
                    <div className="border-l-2 border-stone-900 pl-6">
                        ...
                        <p className="text-[10px] text-stone-400 uppercase tracking-widest">Updating placement in inventory</p>
                    </div>
                ...
                <section className="space-y-8">
                    <div className="border-l-2 border-stone-900 pl-6">
                        ...
                        <p className="text-[10px] text-stone-400 uppercase tracking-widest">Maintained image collection</p>
                    </div>

                    <div className="space-y-4">
                        {images.map((url, index) => (
                            <div key={index} className="flex items-center space-x-4">
                                <div className="w-16 h-16 bg-stone-50 border border-stone-100 overflow-hidden shrink-0">
                ...
                <section className="space-y-8">
                    <div className="border-l-2 border-stone-900 pl-6">
                        ...
                        <p className="text-[10px] text-stone-400 uppercase tracking-widest">Sizing and color options</p>
                    </div>
                ...
                <div className="pt-12 border-t border-stone-100 flex items-center justify-between">
                    ...
                    <button
                        type="submit"
                        disabled={saving}
                        className="bg-stone-900 text-white px-12 py-4 text-[11px] uppercase tracking-[0.3em] font-semibold hover:bg-stone-800 transition-all disabled:opacity-50 flex items-center space-x-3"
                    >
                        <Save size={14} />
